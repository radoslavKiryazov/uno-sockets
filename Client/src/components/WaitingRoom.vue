    ...
    >
        ...
        >
            ...
            <button
                ...
                :title="userStore.connectedPlayers.length <= 1 ? 'Need at least two players to start the game' : ''"
            >
                Start Game
            </button>
        </div>
...
socket.on('game-started', (data) => {
    ...
    console.log('gameStore.state', gameStore.state);
    router.push('/play');
});

socket.on('your-hand', (data) => {
            handStore.state.hand = data.hand;
